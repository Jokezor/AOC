...
void solution() {
  ...
  // Stupid way is to simply brute force.
  // I generate md5 hashes in hex until I find one with 5 preceeding 0s.
  ...
  for (int i=1; i < 100000000; ++i) {
    string newKey = secret + to_string(i);

    string myHash = md5(newKey);
